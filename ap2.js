...
const captcha = require("./captcha2")
...
var url = "https://publicodetran.es.gov.br/boletolicenciamento/consultaBoletoLicenciamento.asp"
    ...
    async function main(){
        ...
        let homePage = await rp.get("https://publicodetran.es.gov.br/boletolicenciamento/consultaBoletoLicenciamento.asp" , {
             gzip:true,
        ...
        await console.log('codico: '+testeCaptcha)
         ...
         let result = await rp(url, {
            ...
            headers: {
                ...
                'Referer':'https://publicodetran.es.gov.br/boletolicenciamento/consultaBoletoLicenciamento.asp',
